...
int main() {
    ...
    double Kp[12] = {0, 0, 0, 39 , 39 , 39, 0, 0, 0, 0, 0, 0};
    double Kd[12] = {0.0, 0.0, 0, 0.6,0.6,0.6,0.0,0.0,0.0};
    ...
    for (int i = 0; i < 100000; i++) {
        ...
        // 调用你的函数
        legControl.SlowStandtoPosition(dt, Kp, Kd, time ,init);
        // legControl.torque_zhengxian_dandianji(postion_target, Kp, Kd, time);
        //legControl.
